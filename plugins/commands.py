...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton("⚡ UᎮDΛTΞS ⚡", url="https://t.me/xCenterOfGravity")
            ],[
            InlineKeyboardButton("🔞 ΛDULϮ BԾϮ 🔞", url="https://t.me/HD_Erotics")
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("🧩 TUϮԾᏒIΛL", url="https://t.me/HDRequestBotTutorial"),
            InlineKeyboardButton("🍿 UᎮDΛTΞS 🍿", url="https://t.me/xCenterOfGravity")
            ],[
